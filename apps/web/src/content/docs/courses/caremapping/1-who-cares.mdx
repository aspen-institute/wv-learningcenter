...
import mindfulnessImage from './images/bamboo.jpg'
...
The Atlas CareMap is part of a larger effort called <a target="_blank" href="https://atlasofcaregiving.com/mappingourselves/">Mapping Ourselves</a>, which encompasses a wider range of topics that impact on wellbeing and belonging. You’ll learn more about Mapping Ourselves in the final unit.
...
<MindfulnessPrompt
  ...
  imageAlt='A dense bamboo forest'
>
...
<Links
  items={[{
    href: "https://community.weavers.org/topic/find-a-buddy-to-work-through-atlas-caremap-module-together ",
    text: "Need a buddy? Find yours in the Online Weave Community"
  }]}
/>
