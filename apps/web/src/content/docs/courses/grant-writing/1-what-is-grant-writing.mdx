...
<Box>
  ...
  Grant writing is typically defined as:

  <MultipleChoice>
    <Option>
      A process of storytelling describing the history of your organization to potential funders
    </Option>
    <Option isCorrect>
      A process of crafting a written proposal to receive grant funding from a grant-making institution (typically known as the funder or donor) in order to fund a program or project
    </Option>
    <Option>
      A series of essays about the organizational need for funding
    </Option>
  </MultipleChoice>
