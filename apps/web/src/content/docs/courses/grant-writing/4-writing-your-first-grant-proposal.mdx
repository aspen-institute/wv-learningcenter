...
<Embed src="https://player.vimeo.com/video/951184875" />
...
<Links
  items={[{
    href: "/downloads/grant-writing/gw-resource-budgettemplate.pdf",
    text: "PDF: Nonprofit Budget Template"
  }]}
/>
...
<Box>
  ...
  Why are funding goals important?

  <MultipleChoice>
    <Option isCorrect>
      Setting measurable goals at the beginning of developing your grant calendar will help you set realistic expectations around the number of grants and the amount you want to submit for the year
    </Option>
    <Option>
      There is no reason to set funding goals.
    </Option>
    <Option>
      Submitting any number of grants helps you get to your goal.
    </Option>
  </MultipleChoice>
