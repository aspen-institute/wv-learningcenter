...
<Box>
  ...
  <MultipleChoice>
    <Option>
      Leadership in organizing is based on relationships
    </Option>
    <Option>
      Organizers commit to working together on behalf of a common purpose
    </Option>
    <Option>
      Relationships created during organizing fuels leadership, commitment, imagination
    </Option>
    <Option isCorrect>
      Organizing is used only for political campaigns
    </Option>
  </MultipleChoice>
