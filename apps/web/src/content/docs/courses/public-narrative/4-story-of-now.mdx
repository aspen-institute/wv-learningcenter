...
<Image src={imgChallengeChoiceOutcome} alt="lightning bolt labeled A) Challenge zapping a dot labeled B) Choice, out of which an arrow labeled C) Outcome points in a different direction"/>
...
<Box>
  ...
  <MultipleChoice>
    <Option>
      It describes a choice to take strategic action together with urgency
    </Option>
    <Option>
      It warns of what will happen if we don’t act
    </Option>
    <Option>
      It is a hopeful story
    </Option>
    <Option isCorrect>
      It includes Challenge, Choice, and Goals
    </Option>
  </MultipleChoice>
