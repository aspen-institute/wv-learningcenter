...
<Box>
  ...
  <MultipleChoice>
    <Option>
      Stop the person who is talking and tell them how you feel in the moment
    </Option>
    <Option>
      Don’t assume the person meant harm
    </Option>
    <Option isCorrect>
      Put the person the the defensive so you can argue your side
    </Option>
    <Option>
      Offer a way forward with language you would suggest using in the conversation
    </Option>
  </MultipleChoice>
